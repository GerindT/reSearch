...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 30, 2023 at 06:38 PM
...
INSERT INTO `comments` (`CommentID`, `CommentText`, `PaperID`, `UserID`, `CreatedAt`, `UpdateAt`) VALUES
(1, 'hello', 1, 1, '2023-12-28', NULL),
(2, 'hello1', 2, 1, '2023-12-28', NULL),
(3, 'hello', 1, 1, '2023-12-28', NULL);
...
(1, 'admin', 'admin@gmail.com', 'admin1234', '/logo.png', 1, 1),
